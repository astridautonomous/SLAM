...
class BoundingBoxStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BoundingBoxStamped(null);
  ...
  static messageDefinition() {
    ...
    return `
    # BoundingBoxStamped is a stamped BoundingBox.
  ...
  static Resolve(msg) {
    ...
    const resolved = new BoundingBoxStamped(null);
...
module.exports = BoundingBoxStamped;
