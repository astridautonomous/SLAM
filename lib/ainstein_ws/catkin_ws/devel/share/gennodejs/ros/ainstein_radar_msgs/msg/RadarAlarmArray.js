...
let RadarAlarm = require('./RadarAlarm.js');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class RadarAlarmArray {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.alarms.forEach((val) => {
      bufferOffset = RadarAlarm.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RadarAlarmArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.alarms[i] = RadarAlarm.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static messageDefinition() {
    ...
    return `
    # This message describes an array of alarms with a timestamp.
  ...
  static Resolve(msg) {
    ...
    const resolved = new RadarAlarmArray(null);
    ...
    if (msg.alarms !== undefined) {
      ...
      for (let i = 0; i < resolved.alarms.length; ++i) {
        resolved.alarms[i] = RadarAlarm.Resolve(msg.alarms[i]);
      }
    }
    else {
      resolved.alarms = []
...
module.exports = RadarAlarmArray;
