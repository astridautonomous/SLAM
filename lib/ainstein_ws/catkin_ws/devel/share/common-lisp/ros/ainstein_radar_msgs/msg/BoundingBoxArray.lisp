...
(cl:defclass <BoundingBoxArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (boxes
    :reader boxes
    :initarg :boxes
    :type (cl:vector ainstein_radar_msgs-msg:BoundingBox)
   :initform (cl:make-array 0 :element-type 'ainstein_radar_msgs-msg:BoundingBox :initial-element (cl:make-instance 'ainstein_radar_msgs-msg:BoundingBox))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ainstein_radar_msgs-msg:<BoundingBoxArray> is deprecated: use ainstein_radar_msgs-msg:BoundingBoxArray instead.")))
...
(cl:defmethod boxes-val ((m <BoundingBoxArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ainstein_radar_msgs-msg:boxes-val is deprecated.  Use ainstein_radar_msgs-msg:boxes instead.")
  (boxes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBoxArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ainstein_radar_msgs-msg:BoundingBox))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BoundingBoxArray>)))
  ...
  "ainstein_radar_msgs/BoundingBoxArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BoundingBoxArray)))
  "Returns string type for a message object of type 'BoundingBoxArray"
  "ainstein_radar_msgs/BoundingBoxArray")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BoundingBoxArray>)))
  ...
  "2ea1dfa56cda09dce8368482c68738e3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BoundingBoxArray)))
  "Returns md5sum for a message object of type 'BoundingBoxArray"
  "2ea1dfa56cda09dce8368482c68738e3")
