...
#include "../../../../src/ainstein_radar_rviz_plugins/src/radar_info/radar_info_display.h"
...
void ainstein_radar_rviz_plugins::RadarInfoDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RadarInfoDisplay *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ainstein_radar_rviz_plugins::RadarInfoDisplay::staticMetaObject = { {
    &rviz::MessageFilterDisplay<ainstein_radar_msgs::RadarInfo>::staticMetaObject,
    qt_meta_stringdata_ainstein_radar_rviz_plugins__RadarInfoDisplay.data,
    qt_meta_data_ainstein_radar_rviz_plugins__RadarInfoDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
