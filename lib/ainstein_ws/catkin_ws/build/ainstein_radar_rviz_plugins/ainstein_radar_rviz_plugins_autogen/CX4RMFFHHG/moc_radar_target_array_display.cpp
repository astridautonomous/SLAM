...
#include "../../../../src/ainstein_radar_rviz_plugins/src/radar_target_array/radar_target_array_display.h"
...
void ainstein_radar_rviz_plugins::RadarTargetArrayDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RadarTargetArrayDisplay *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ainstein_radar_rviz_plugins::RadarTargetArrayDisplay::staticMetaObject = { {
    &rviz::MessageFilterDisplay<ainstein_radar_msgs::RadarTargetArray>::staticMetaObject,
    qt_meta_stringdata_ainstein_radar_rviz_plugins__RadarTargetArrayDisplay.data,
    qt_meta_data_ainstein_radar_rviz_plugins__RadarTargetArrayDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
