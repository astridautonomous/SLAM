...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/usr/bin/git" rev-parse "${ref}"
...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v0.15.1"
  WORKING_DIRECTORY "/home/tezcan/Work_Spaces/open3d_ws/src/open3d"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v0.15.1" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v0.15.1")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/tezcan/Work_Spaces/open3d_ws/src/open3d'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/tezcan/Work_Spaces/open3d_ws/src/open3d'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
