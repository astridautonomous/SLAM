...
"""autogenerated by genpy from open3d_slam_msgs/PolygonMesh.msg. Do not edit."""
import codecs
import sys
...
import open3d_slam_msgs.msg
import sensor_msgs.msg
import std_msgs.msg

class PolygonMesh(genpy.Message):
  _md5sum = "45a5fc6ad2cde8489600a790acc9a38a"
  _type = "open3d_slam_msgs/PolygonMesh"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Separate header for the polygonal surface
Header header
...
uint32[] vertices"""
  ...
  _slot_types = ['std_msgs/Header','sensor_msgs/PointCloud2','open3d_slam_msgs/Vertices[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PolygonMesh, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.polygons:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(struct.Struct(pattern).pack(*val1.vertices))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.polygons = []
      for i in range(0, length):
        val1 = open3d_slam_msgs.msg.Vertices()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sI'%length
        ...
        val1.vertices = s.unpack(str[start:end])
