...
(cl:defmethod cl:initialize-instance :after ((m <Vertices>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vertices)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name open3d_slam_msgs-msg:<Vertices> is deprecated: use open3d_slam_msgs-msg:Vertices instead.")))

(cl:ensure-generic-function 'vertices-val :lambda-list '(m))
(cl:defmethod vertices-val ((m <Vertices>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader open3d_slam_msgs-msg:vertices-val is deprecated.  Use open3d_slam_msgs-msg:vertices instead.")
  (vertices m))
