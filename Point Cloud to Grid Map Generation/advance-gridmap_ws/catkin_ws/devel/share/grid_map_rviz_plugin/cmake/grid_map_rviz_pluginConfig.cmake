...
if("TRUE" STREQUAL "TRUE")
  set(grid_map_rviz_plugin_SOURCE_PREFIX /home/tezcan/Work_Spaces/gridmap_ws/catkin_ws/src/grid_map/grid_map_rviz_plugin)
  set(grid_map_rviz_plugin_DEVEL_PREFIX /home/tezcan/Work_Spaces/gridmap_ws/catkin_ws/devel)
  ...
  set(grid_map_rviz_plugin_INSTALL_PREFIX /home/tezcan/Work_Spaces/gridmap_ws/catkin_ws/install)
...
if(NOT "/home/tezcan/Work_Spaces/gridmap_ws/catkin_ws/src/grid_map/grid_map_rviz_plugin/include " STREQUAL " ")
  set(grid_map_rviz_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/home/tezcan/Work_Spaces/gridmap_ws/catkin_ws/src/grid_map/grid_map_rviz_plugin/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'grid_map_rviz_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tezcan/Work_Spaces/gridmap_ws/catkin_ws/src/grid_map/grid_map_rviz_plugin/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT grid_map_rviz_plugin_NUM_DUMMY_TARGETS)
      set(grid_map_rviz_plugin_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::grid_map_rviz_plugin::wrapped-linker-option${grid_map_rviz_plugin_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR grid_map_rviz_plugin_NUM_DUMMY_TARGETS "${grid_map_rviz_plugin_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::grid_map_rviz_plugin::wrapped-linker-option${grid_map_rviz_plugin_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND grid_map_rviz_plugin_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(grid_map_rviz_plugin_EXPORTED_TARGETS ${${grid_map_rviz_plugin_dep}_EXPORTED_TARGETS})
endforeach()
