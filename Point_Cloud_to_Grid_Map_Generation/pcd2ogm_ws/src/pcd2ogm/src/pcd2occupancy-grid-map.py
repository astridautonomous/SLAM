...
if __name__ == "__main__":
    ...
    pcd = o3d.io.read_point_cloud("/home/tezcan/sim_git/SLAM/Point_Cloud_to _Grid_Map_Generation/pcd2ogm_ws/src/pcd2ogm/src/testdrive_carla.pcd") # Add here yours ".pcd" file
