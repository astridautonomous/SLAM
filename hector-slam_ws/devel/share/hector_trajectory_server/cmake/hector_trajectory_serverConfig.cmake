...
if("TRUE" STREQUAL "TRUE")
  set(hector_trajectory_server_SOURCE_PREFIX /home/tezcan/Work_Spaces/slam_ws/src/hector_slam/hector_trajectory_server)
  set(hector_trajectory_server_DEVEL_PREFIX /home/tezcan/Work_Spaces/slam_ws/devel)
  ...
  set(hector_trajectory_server_INSTALL_PREFIX /home/tezcan/Work_Spaces/slam_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_trajectory_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tezcan/Work_Spaces/slam_ws/src/hector_slam/hector_trajectory_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT hector_trajectory_server_NUM_DUMMY_TARGETS)
      set(hector_trajectory_server_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::hector_trajectory_server::wrapped-linker-option${hector_trajectory_server_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR hector_trajectory_server_NUM_DUMMY_TARGETS "${hector_trajectory_server_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::hector_trajectory_server::wrapped-linker-option${hector_trajectory_server_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND hector_trajectory_server_LIBRARIES "${interface_target_name}")
...
set(depends "roscpp;hector_nav_msgs;nav_msgs;hector_map_tools;tf")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(hector_trajectory_server_EXPORTED_TARGETS ${${hector_trajectory_server_dep}_EXPORTED_TARGETS})
endforeach()
