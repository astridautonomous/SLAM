...
if("TRUE" STREQUAL "TRUE")
  set(hector_compressed_map_transport_SOURCE_PREFIX /home/tezcan/Work_Spaces/slam_ws/src/hector_slam/hector_compressed_map_transport)
  set(hector_compressed_map_transport_DEVEL_PREFIX /home/tezcan/Work_Spaces/slam_ws/devel)
  ...
  set(hector_compressed_map_transport_INSTALL_PREFIX /home/tezcan/Work_Spaces/slam_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_compressed_map_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tezcan/Work_Spaces/slam_ws/src/hector_slam/hector_compressed_map_transport/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT hector_compressed_map_transport_NUM_DUMMY_TARGETS)
      set(hector_compressed_map_transport_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::hector_compressed_map_transport::wrapped-linker-option${hector_compressed_map_transport_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR hector_compressed_map_transport_NUM_DUMMY_TARGETS "${hector_compressed_map_transport_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::hector_compressed_map_transport::wrapped-linker-option${hector_compressed_map_transport_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND hector_compressed_map_transport_LIBRARIES "${interface_target_name}")
...
set(depends "geometry_msgs;nav_msgs;sensor_msgs")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(hector_compressed_map_transport_EXPORTED_TARGETS ${${hector_compressed_map_transport_dep}_EXPORTED_TARGETS})
endforeach()
