...
if("TRUE" STREQUAL "TRUE")
  set(carla_ego_vehicle_SOURCE_PREFIX /home/tezcan/Work_Spaces/carla-ros-slam_ws/src/carla_ego_vehicle)
  set(carla_ego_vehicle_DEVEL_PREFIX /home/tezcan/Work_Spaces/carla-ros-slam_ws/devel)
  ...
  set(carla_ego_vehicle_INSTALL_PREFIX /home/tezcan/Work_Spaces/carla-ros-slam_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'carla_ego_vehicle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tezcan/Work_Spaces/carla-ros-slam_ws/src/carla_ego_vehicle/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT carla_ego_vehicle_NUM_DUMMY_TARGETS)
      set(carla_ego_vehicle_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::carla_ego_vehicle::wrapped-linker-option${carla_ego_vehicle_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR carla_ego_vehicle_NUM_DUMMY_TARGETS "${carla_ego_vehicle_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::carla_ego_vehicle::wrapped-linker-option${carla_ego_vehicle_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND carla_ego_vehicle_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(carla_ego_vehicle_EXPORTED_TARGETS ${${carla_ego_vehicle_dep}_EXPORTED_TARGETS})
endforeach()
