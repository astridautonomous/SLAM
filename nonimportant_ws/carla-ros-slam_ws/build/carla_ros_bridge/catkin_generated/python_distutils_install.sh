...
echo_and_run cd "/home/tezcan/Work_Spaces/carla-ros-slam_ws/src/carla_ros_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/home/tezcan/Work_Spaces/carla-ros-slam_ws/src/carla_ros_bridge/setup.py" \
     \
    build --build-base "/home/tezcan/Work_Spaces/carla-ros-slam_ws/build/carla_ros_bridge" \
    install \
    --root="${DESTDIR-/}" \
