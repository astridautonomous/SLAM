...
echo_and_run cd "/home/tezcan/Work_Spaces/carla-ros-slam_ws/src/carla_manual_control"
...
echo_and_run /usr/bin/env \
    ...
    "/home/tezcan/Work_Spaces/carla-ros-slam_ws/src/carla_manual_control/setup.py" \
     \
    build --build-base "/home/tezcan/Work_Spaces/carla-ros-slam_ws/build/carla_manual_control" \
    install \
    --root="${DESTDIR-/}" \
