...
echo_and_run cd "/home/tezcan/Work_Spaces/carla-ros-slam_ws/src/carla_ego_vehicle"
...
echo_and_run /usr/bin/env \
    ...
    "/home/tezcan/Work_Spaces/carla-ros-slam_ws/src/carla_ego_vehicle/setup.py" \
     \
    build --build-base "/home/tezcan/Work_Spaces/carla-ros-slam_ws/build/carla_ego_vehicle" \
    install \
    --root="${DESTDIR-/}" \
